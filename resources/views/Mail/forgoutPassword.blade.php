                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://assets.unlayer.com/projects/53551/1708532904193-tocomkleber.png"
                                                                            alt="" title=""
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <h4
                                                                style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: inherit; font-size: 16px; font-weight: 400;">
                                                                <span><span><span><span>{{ $data['message'] }}</span></span></span></span></h4>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div align="center">
                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://127.0.0.1:8000/forgout-password" style="height:37px; v-text-anchor:middle; width:480px;" arcsize="11%"  stroke="f" fillcolor="#0078be"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
                                                                <a href="https://tocomkleberfernandes.com.br/forgout-password/{{ $data['code'] }}"
                                                                    target="_blank" class="v-button"
                                                                    style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #0078be; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:100%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                                                                    <span
                                                                        style="display:block;padding:10px 20px;line-height:120%;"><span
                                                                            style="line-height: 16.8px;">{{ $data['code'] }}</span></span>
                                                                </a>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 140%;">Caso não reconheça
                                                                    nenhuma atividade, descarte esse E-mail.</p>
                                                            </div>
